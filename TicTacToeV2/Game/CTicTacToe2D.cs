...
namespace TicTacToeV2
{
	...
	{
		public string		Name		=> "TicTacToe 2D";
		public string		Description => "Tic Tac Toe game. What more do you need to know :D";
		...
		/// <summary>
		/// Read only list of all players
		/// </summary>
		public ReadOnlyCollection<APlayer> Players => _players.AsReadOnly();
		...
		private void Initialize()
		{
			...
			_freeCellsLeft = GridSize * GridSize;
		}
		...
		private void GameLoop()
		{
			...
			{
				//Write game
				//TODO: Make more efficient - do not redraw everything
